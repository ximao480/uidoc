...
const routers = [
  {
    ...
    component: (resolve) => require(['./views/index-2020-year.vue'], resolve)
  },
  // {
  //     path: '/vue-book',
  //     meta: {
  ...
  },
  {
    ...
    component: (resolve) => require(['./views/bcl/DropDownSelectFilter'], resolve)
  },
  {
    ...
    component: (resolve) => require(['./views/bcl/DropMultiSelectFilter'], resolve)
  },
  {
    path: '/bcl/Docfile',
    meta: {
