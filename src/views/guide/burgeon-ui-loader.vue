<template>
    <i-article>
        <article>
            <h1>burgeon-ui Loader</h1>
            <inAnchor title="用途" h2></inAnchor>
            <p>统一 burgeon-ui 标签书写规范，所有标签都可以使用首字母大写的形式，包括 Vue 限制的两个标签 <code>Switch</code> 和 <code>Circle</code>。</p>
