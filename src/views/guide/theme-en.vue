...
<template>
    <i-article>
        <article>
            ...
            <p>iView uses <a href="http://lesscss.org/" target="_blank">Less</a> as developing language of styles. We use <code>.burgeon-</code> as prefix, and have defined a set of variables which can be customized.</p>
