...
<template>
    <i-article>
        <article>
            ...
            <p>ark-ui 推荐使用以下调色板的颜色作为设计和开发规范，以保证页面和组件之间的视觉一致。</p>
            <inAnchor title="主色" h3></inAnchor>
            <p>ark-ui 使用较为安全的蓝色作为主色调，其中 Light Primary 常用于 hover，Dark Primary 常用于 active。</p>
            <Row :gutter="16">
                <i-col span="8">
            ...
            <br>
            <inAnchor title="辅助色" h3></inAnchor>
            ...
            <br>
            <inAnchor title="中性色" h3></inAnchor>
