            ...
            <div class="api">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>styles</td>
                            <td>Set layer's style or adjust its position. The prop sets <code>.burgeon-modal</code>'s style.</td>
                            <td>Object</td>
                            <td>-</td>
                        </tr>
                        <tr>
                            <td>class-name</td>
                            <td>Set Modal's wrapper - <code>.burgeon-modal-wrap</code>'s class name. It can be used to assist to realise custom styles like vertical center.</td>
                            <td>String</td>
                            <td>-</td>
                        </tr>
                        <tr>
